...
def Imprimir_valores(database):
  print(precio_mayor(database),
        precio_menor(database),
        round(promedio_precios(database),1),
        round(valor_inventario(database),1))
